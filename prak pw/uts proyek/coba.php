						...
						<form action="update.php" method="post">
							...
							<div class="step show-form">
									...
									<div class="row">
										<div class="col">
											<input type="text" class="form-control" name="tmptLAHIR" id="ttl"
												placeholder="Kota Kelahiran" value="<?php $kolom['tmpt_lahir']?>">
										</div>
										<div class="col">
											<input type="date" class="form-control" name="tglLAHIR" id="ttl"
												placeholder="Tanggal lahir" value="<?php $kolom['tgl_lahir']?>">
										</div>
									</div>
								</div>
								<!-- JENIS KELAMIN -->
								<div class="form-group">
									...
									<select class="form-control" id="gender" name="gender" value="<?php $kolom['gender']?>">
								...
								<div class="form-group">
									...
									<select class="form-control" id="agama" name="agama" value="<?php $kolom['agama']?>">
							...
							<div class="step2 hide-form"> 
									...
									<div class="row">
										<div class="col">
											<input type="text" class="form-control" name="lama-studi-thn"
												id="lama-studi" placeholder="Tahun" value="<?php $kolom['lama_studi_thn']?>">
										</div>
										<div class="col">
											<input type="text" class="form-control" name="lama-studi-bln"
												id="lama-studi" placeholder="Bulan" value="<?php $kolom['lama_studi_bln']?>">
										</div>
									</div>
								</div>
								<!-- IPK Terakhir----------- -->
								<div class="form-group">
									...
									placeholder="4.00 (Gunakan titik sebagai koma)" value="<?php $kolom['ipk']?>">
								</div>
								<!-- DESKRIPSI -->
								<div class="form-group">
                                    ...
                                    value="<?php $kolom['desc_diri']?>"></textarea>
								</div>
								<br />
								<!-- PREV BTN -->
